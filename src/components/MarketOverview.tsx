                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm transition-all ${
                    activeCategory === category.id 
                      ...
                      : 'bg-foreground/40 text-foreground/70 hover:bg-foreground/20'
                  }`}
              ...
              <table className="w-full">
                ...
                <tbody>
                  {cryptoData.map((crypto, index) => (
                    ...
                    >
                      <td className="py-1 px-2 flex items-center text-center">
                      ...
                      <td className="py-1 px-2 items-center text-center font-medium">${crypto.price}</td>
                      <td className={`py-1 px-2 items-center text-center font-medium ${crypto.change >= 0 ? 'positive' : 'negative'}`}>
